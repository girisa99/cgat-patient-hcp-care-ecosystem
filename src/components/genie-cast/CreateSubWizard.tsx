...
export const CreateSubWizard: React.FC<CreateSubWizardProps> = ({
  ...
  const steps = useMemo<WizardStep[]>(() => [
    ...
    },
    {
      id: 'templates',
      label: 'Blueprints',
      localLabel: direction === 'rtl' ? 'المخططات' : undefined,
      description: 'Production-Ready Pipelines',
      localDescription: direction === 'rtl' ? 'خطوط إنتاج جاهزة' : undefined,
    ...
    },
    {
      id: 'assets',
      label: 'Publish & Scale',
      localLabel: direction === 'rtl' ? 'النشر والتوسع' : undefined,
      description: '14 Regions × 6+ Platforms',
      localDescription: direction === 'rtl' ? '14 منطقة × 6+ منصات' : undefined,
