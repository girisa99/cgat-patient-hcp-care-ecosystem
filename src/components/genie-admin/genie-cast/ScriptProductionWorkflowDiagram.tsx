...
const STAGES = [
  ...
  {
    number: 2,
    title: 'Regional Transcreation (62 Sub-Regions)',
    icon: GitBranch,
    color: 'bg-purple-500',
    description: 'English base auto-expands into 82+ leaf nodes (via zone grouping) using zone-routed LLMs with hybrid sub-region overrides',
    routing: [
       { zone: 'NAM / EU_WEST / EU_DACH / EU_FRANCE / EU_IBERIA / LATAM_BRAZIL / LATAM_MEXICO / LATAM_CONESUR / MENA_MAGHREB / SEA_PH / SEA_PAN_EN / OCEANIA / TURKEY', provider: 'Claude 4', fallback: 'GPT-4o → Gemini → DeepSeek' },
       ...
       { zone: 'EU_NORDIC / EU_EAST / LATAM_ANDEAN / LATAM_CARIB / MENA_EGYPT / MENA_LEVANT / PAKISTAN / CARIBBEAN / EURASIA / CENTRAL_ASIA', provider: 'GPT-4o', fallback: 'Claude 4 / Qwen Max → DeepSeek' },
     ],
     subRegions: {
       'Europe (6 zones → 15 leaves)': ['EU_WEST → Claude 4', 'EU_DACH (DE/AT/CH) → Claude 4', 'EU_FRANCE → Claude 4', 'EU_IBERIA (ES/PT/IT) → Claude 4', 'EU_NORDIC (SE/NO/DK/FI) → GPT-4o', 'EU_EAST (PL/CZ/RO/HU) → GPT-4o'],
       ...
       'CJK (4)': ['CJK_CN → Qwen Max', 'CJK_TW → Qwen Max', 'CJK_JP → GPT-4o', 'CJK_KR → GPT-4o'],
       ...
       'SEA (5)': ['SEA_MALAY → Gemini 3', 'SEA_THAI → Gemini 3', 'SEA_VIET → Gemini 3', 'SEA_PHIL → Claude 4', 'SEA_PAN → Claude 4'],
       'Africa (4)': ['AFRICA_EAST → Gemini 3', 'AFRICA_WEST → Gemini 3', 'AFRICA_SOUTH → Gemini 3', 'AFRICA_FRANCO → Gemini 3'],
       'Oceania (2)': ['OCEANIA_AU → Claude 4', 'OCEANIA_NZ → Claude 4'],
       'Turkey (1)': ['TURKEY → Claude 4'],
       'Caribbean (2)': ['CARIBBEAN_EN → GPT-4o', 'CARIBBEAN_FR → GPT-4o'],
       'Eurasia (3)': ['EU_UKRAINE → GPT-4o', 'EU_BALKANS → GPT-4o', 'EU_CAUCASUS → GPT-4o'],
       'Central Asia (5)': ['ASIA_CENTRAL_KZ → GPT-4o', 'ASIA_CENTRAL_UZ → GPT-4o', 'ASIA_CENTRAL_AZ → GPT-4o', 'ASIA_CENTRAL_AM → GPT-4o', 'ASIA_CENTRAL_GE → GPT-4o'],
       'Standalone (2)': ['PAKISTAN → GPT-4o', 'BANGLADESH → Gemini 3'],
     },
    outputs: ['82+ regional leaf scripts', 'Cultural adaptation + local idioms + formality registers'],
  ...
  },
  {
    ...
    routing: [
       { zone: 'NAM / EU / LATAM / MENA / India / SEA / Africa / Pakistan / Bangladesh / Oceania / Turkey / Caribbean / Eurasia / Central Asia', provider: 'Azure Neural (45+ locales)', fallback: 'Viseme lip-sync data for all' },
