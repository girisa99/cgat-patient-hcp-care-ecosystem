...
export const TEMPLATE_DEFINITIONS: TemplateDefinition[] = [
  ...
  {
    id: 'industry_saudi_vision',
    label: 'Saudi Vision 2030',
    icon: <Sparkles className="w-5 h-5" />,
    desc: '5 chapters, 125s - GCC',
    chapters: [
      { title: 'The Vision', type: 'animation', duration: 20, description: 'Cinematic reveal of Saudi Vision 2030' },
      { title: 'From Oil to Innovation', type: '3d', duration: 30, description: '3D transformation: oil rigs to tech hubs' },
      { title: 'Tourism Renaissance', type: 'video', duration: 35, description: 'AlUla, Red Sea Project showcase' },
      { title: 'AI Leadership', type: 'avatar', duration: 25, description: 'Regional avatar explains SDAIA investments' },
      { title: 'The Future Awaits', type: 'animation', duration: 15, description: 'Partnership CTA' },
    ],
    landingPageSection: 'Industry Showcases',
    landingPageDescription: 'Saudi Arabia\'s transformation from oil & gas to tourism and AI hub. Auto-plays for GCC visitors.',
    socialPlatforms: ['youtube', 'linkedin', 'twitter'],
    totalDuration: 125,
    regionalSupport: ['Arabic (7 dialects)', 'English', 'French', 'Chinese', 'Japanese'],
  },
  {
    id: 'industry_india_digital',
    label: 'Digital India',
    icon: <Sparkles className="w-5 h-5" />,
    desc: '4 chapters, 100s - South Asia',
    chapters: [
      { title: 'Digital India Vision', type: 'animation', duration: 20, description: 'Map of India lighting up' },
      { title: 'UPI Revolution', type: 'video', duration: 30, description: 'UPI payments transforming commerce' },
      { title: 'Aadhaar Impact', type: 'avatar', duration: 30, description: 'Digital identity reaching 1.4B' },
      { title: 'Startup Ecosystem', type: '3d', duration: 20, description: '3D visualization of tech hubs' },
    ],
    landingPageSection: 'Industry Showcases',
    landingPageDescription: 'India\'s digital transformation story. Auto-plays for South Asian visitors.',
    socialPlatforms: ['youtube', 'linkedin'],
    totalDuration: 100,
    regionalSupport: ['Hindi', 'Tamil', 'Telugu', 'Bengali', 'English', '+17 more'],
  },
  {
    id: 'industry_healthcare_ai',
    label: 'AI Healthcare',
    icon: <Sparkles className="w-5 h-5" />,
    desc: '4 chapters, 100s - Global',
    chapters: [
      { title: 'The Challenge', type: 'video', duration: 20, description: 'Healthcare diagnostic challenges' },
      { title: 'AI Diagnostics', type: '3d', duration: 30, description: 'AI analyzing medical images' },
      { title: 'Patient Stories', type: 'avatar', duration: 30, description: 'Doctor avatar shares success' },
      { title: 'Implementation', type: 'animation', duration: 20, description: 'Integration steps' },
    ],
    landingPageSection: 'Industry Showcases',
    landingPageDescription: 'AI-powered healthcare diagnostics. Auto-plays for healthcare industry visitors.',
    socialPlatforms: ['youtube', 'linkedin', 'facebook'],
    totalDuration: 100,
    regionalSupport: ['English', 'Spanish', 'Portuguese', 'French', 'German'],
  },
  {
    id: 'industry_fintech_africa',
    label: 'African FinTech',
    icon: <Sparkles className="w-5 h-5" />,
    desc: '4 chapters, 95s - Africa',
    chapters: [
      { title: 'The Opportunity', type: 'animation', duration: 20, description: 'Mobile penetration across Africa' },
      { title: 'Mobile Money', type: 'video', duration: 30, description: 'Mobile banking in daily life' },
      { title: 'AI Credit Scoring', type: '3d', duration: 25, description: 'Alternative data analysis' },
      { title: 'Partnership', type: 'avatar', duration: 20, description: 'African avatar explains model' },
    ],
    landingPageSection: 'Industry Showcases',
    landingPageDescription: 'Inclusive banking for Africa. Auto-plays for African visitors.',
    socialPlatforms: ['youtube', 'linkedin', 'twitter'],
    totalDuration: 95,
    regionalSupport: ['English', 'Swahili', 'French', 'Arabic', 'Hausa', 'Yoruba'],
  },
  {
    id: 'industry_edtech_global',
    label: 'EdTech AI Tutor',
    icon: <Sparkles className="w-5 h-5" />,
    desc: '4 chapters, 95s - Global',
    chapters: [
      { title: 'Learning Diversity', type: 'animation', duration: 20, description: 'Diverse learning styles' },
      { title: 'Adaptive AI', type: 'avatar', duration: 35, description: 'AI tutor demonstrates' },
      { title: 'Real Results', type: 'video', duration: 25, description: 'Student testimonials' },
      { title: 'Get Started', type: 'animation', duration: 15, description: 'Implementation CTA' },
    ],
    landingPageSection: 'Industry Showcases',
    landingPageDescription: 'AI-powered personalized learning. Auto-plays for education sector visitors.',
    socialPlatforms: ['youtube', 'linkedin', 'facebook'],
    totalDuration: 95,
    regionalSupport: ['English', 'German', 'French', 'Spanish', 'Italian', 'Dutch'],
  },
];
