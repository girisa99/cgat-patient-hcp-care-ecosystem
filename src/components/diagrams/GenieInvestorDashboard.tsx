...
const segments = [
  {
    ...
    collaboration: 'Basic',
    competitors: [
      { name: 'Descript', pricing: '$12-24/mo', threat: 'High', gap: 'No real-time collaboration' },
      { name: 'CapCut', pricing: 'Free/$8/mo', threat: 'High', gap: 'No script-first workflow' },
      { name: 'Riverside.fm', pricing: '$15-24/mo', threat: 'Medium', gap: 'Limited post-production' },
      { name: 'Kapwing', pricing: '$16-24/mo', threat: 'Medium', gap: 'Basic AI features' },
    ],
    painPoints: [
  ...
  },
  {
    ...
    collaboration: 'None',
    competitors: [
      { name: 'InShot', pricing: 'Free/$3.99/mo', threat: 'Medium', gap: 'No AI narration' },
      { name: 'GoPro Quik', pricing: 'Free/$9.99/yr', threat: 'Low', gap: 'GoPro-only' },
    ],
    painPoints: [
  ...
  },
  {
    ...
    competitors: [
      { name: 'Loom', pricing: '$12.50/mo', threat: 'High', gap: 'No AI editing' },
      { name: 'Synthesia', pricing: '$22-67/mo', threat: 'High', gap: 'Expensive, robotic' },
      { name: 'Pictory', pricing: '$19-39/mo', threat: 'Medium', gap: 'Template-bound' },
      { name: 'Canva Video', pricing: '$12.99/mo', threat: 'Medium', gap: 'Basic editing' },
    ],
    painPoints: [
      '"Can\'t afford a video team"',
  ...
  },
  {
    ...
    collaboration: 'Full',
    competitors: [
      { name: 'Panopto', pricing: 'Custom', threat: 'High', gap: 'Enterprise pricing' },
      { name: 'Edpuzzle', pricing: 'Free/$8/mo', threat: 'Medium', gap: 'Limited creation' },
      { name: 'WeVideo', pricing: '$4.99-15.99/mo', threat: 'Medium', gap: 'Dated UI' },
    ],
    painPoints: [
  ...
  },
  {
    ...
    collaboration: 'Full',
    competitors: [
      { name: 'Healthwise', pricing: 'Custom', threat: 'Medium', gap: 'No customization' },
      { name: 'Emmi Solutions', pricing: 'Custom', threat: 'Medium', gap: 'Expensive' },
    ],
    painPoints: [
  ...
  },
  {
    ...
    collaboration: 'Full',
    competitors: [
      { name: 'Brightcove', pricing: 'Custom', threat: 'Medium', gap: 'No creation tools' },
      { name: 'Kaltura', pricing: 'Custom', threat: 'High', gap: 'Overwhelming complexity' },
      { name: 'Synthesia Enterprise', pricing: 'Custom', threat: 'Medium', gap: 'Robotic feel' },
    ],
    painPoints: [
