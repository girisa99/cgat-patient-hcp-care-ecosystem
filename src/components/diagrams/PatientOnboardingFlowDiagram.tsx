        ...
        >
            ...
            <div className="ml-11 grid grid-cols-7 gap-2">
              {[
                ...
                <div key={doc.name} className={`${doc.color} border rounded-lg p-2 text-center`}>
                  ...
                  <span className="text-[9px] text-foreground font-medium leading-tight block">{doc.name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="ml-11 bg-gradient-to-r from-purple-100 to-purple-50 dark:from-purple-900/50 dark:to-purple-950/50 border border-purple-400 dark:border-purple-500 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-foreground font-medium text-sm">Gemini 2.5 Flash</span>
                <span className="text-purple-600 dark:text-purple-300 text-xs">— Auto-detects type + manufacturer/source</span>
              </div>
              <div className="grid grid-cols-7 gap-2">
                {[
                  ...
                  <div key={item.type} className="bg-purple-200/60 dark:bg-purple-800/40 rounded px-2 py-1.5 text-center">
                    <span className="text-[9px] text-foreground block font-medium">{item.type}</span>
                    <span className="text-[8px] text-purple-600 dark:text-purple-300">→ {item.detected}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="mb-4">
            ...
            <div className="ml-11 bg-gradient-to-r from-cyan-100 to-cyan-50 dark:from-cyan-900/50 dark:to-cyan-950/50 border border-cyan-400 dark:border-cyan-500 rounded-lg p-4">
              <div className="text-xs text-muted-foreground mb-3 text-center">Route to optimal model per document type</div>
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={model.name} className="bg-white/80 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-600 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-lg">{model.icon}</span>
                      <span className="text-xs text-foreground font-medium">{model.name}</span>
                    </div>
                    <div className="text-[10px] text-cyan-600 dark:text-cyan-400 mb-1">{model.task}</div>
                    <div className="text-[9px] text-muted-foreground">→ {model.docs}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="ml-11 grid grid-cols-4 gap-3">
              {[
                ...
                <div key={record.name} className={`${record.color} border rounded-lg p-3 text-center`}>
                  <span className="text-sm font-medium block text-foreground">{record.name}</span>
          ...
          <div className="mb-4">
            ...
            <div className="ml-11 flex gap-3">
              {[
                ...
                <div key={agent.name} className="flex-1 bg-yellow-100/60 dark:bg-yellow-900/30 border border-yellow-400 dark:border-yellow-500/50 rounded-lg p-3 flex items-center justify-between">
            ...
            <div className="ml-11 grid grid-cols-4 gap-3">
              {[
                ...
                <div key={system.name} className={`${system.color} border rounded-lg p-3 text-center`}>
                  ...
                  <span className="text-xs text-foreground font-medium">{system.name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-border">
            <div className="flex justify-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-muted-foreground">Stage 1: Classification</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-cyan-500"></div>
                <span className="text-[10px] text-muted-foreground">Stage 2: Routing</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                <span className="text-[10px] text-muted-foreground">Sub-Agent Verification</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-pink-500"></div>
                <span className="text-[10px] text-muted-foreground">MCP SDK Integration</span>
              </div>
            </div>
          </div>
        </div>
