...
const ExternalIntegrationTab: React.FC = () => {
  ...
  const handleCreateMapping = () => {
    // Switch to the mappings tab instead of opening a new window
    setActiveSubTab('mappings');
  };

  const handlePublishApi = () => {
    // Switch to the publishing pipeline tab instead of opening a new window
    setActiveSubTab('publishing');
  };
