...
const ALL_INDUSTRIES: IndustryDefinition[] = [
  ...
  { id: 'banking', name: 'Retail Banking', segment: 'Banking', requiredCategories: ['INPUT', 'SCRIPT', 'VOICE'], primaryProviders: ['openai', 'azure', 'elevenlabs'], primaryModels: [{ type: 'text', modelIds: ['gpt-5', 'azure-gpt-4o'], tier: 3 }], compatibleFrameworks: ['customer-lifecycle', 'regulatory'], compatibleOutputs: ['pdf-export', 'video-short', 'interactive'], scenarios: ['Product education', 'Compliance training', 'Branch materials'], useCases: ['Customer onboarding', 'Teller training', 'Digital banking guides'] },
  ...
  { id: 'cybersecurity', name: 'Cybersecurity', segment: 'Security', requiredCategories: ['INPUT', 'SCRIPT', 'IMAGE'], primaryProviders: ['openai', 'azure'], primaryModels: [{ type: 'text', modelIds: ['gpt-5', 'azure-gpt-4o'], tier: 3 }], compatibleFrameworks: ['risk-assessment', 'regulatory', 'soc2'], compatibleOutputs: ['pdf-export', 'pptx-export', 'interactive'], scenarios: ['Threat briefings', 'Compliance audits', 'Security training'], useCases: ['Executive briefings', 'SOC reports', 'Employee training'] },
  ...
  // Retail & Consumer
  { id: 'retail', name: 'Retail', segment: 'Retail', requiredCategories: ['INPUT', 'SCRIPT', 'IMAGE', 'VIDEO', 'INTERACTIVE'], primaryProviders: ['openai', 'modelslab', 'runway'], primaryModels: [{ type: 'image', modelIds: ['flux-pro', 'gpt-image-1'], tier: 2 }], compatibleFrameworks: ['omnichannel', 'customer-lifecycle', 'retail-analytics'], compatibleOutputs: ['social-media', 'video-short', 'interactive', 'ar-overlay'], scenarios: ['Product launches', 'Seasonal campaigns', 'Store displays'], useCases: ['Ad creatives', 'Digital signage', 'AR try-on'] },
  ...
  { id: 'food-beverage', name: 'Food & Beverage', segment: 'F&B', requiredCategories: ['INPUT', 'SCRIPT', 'IMAGE', 'VIDEO'], primaryProviders: ['openai', 'modelslab'], primaryModels: [{ type: 'image', modelIds: ['flux-pro', 'gpt-image-1'], tier: 2 }], compatibleFrameworks: ['customer-lifecycle', 'omnichannel'], compatibleOutputs: ['social-media', 'video-short', 'print-ready', 'ar-overlay'], scenarios: ['Menu design', 'Recipe content', 'Brand campaigns'], useCases: ['Food photography', 'Social media', 'Menu boards'] },
  ...
  { id: 'hospitality', name: 'Hospitality', segment: 'Hospitality', requiredCategories: ['INPUT', 'SCRIPT', 'IMAGE', 'VIDEO', 'TRANSLATION'], primaryProviders: ['openai', 'modelslab', 'deepl'], primaryModels: [{ type: 'image', modelIds: ['flux-pro', 'gpt-image-1'], tier: 2 }], compatibleFrameworks: ['customer-lifecycle', 'omnichannel'], compatibleOutputs: ['video-short', 'social-media', 'interactive', 'ar-overlay'], scenarios: ['Property marketing', 'Guest experience', 'Staff training'], useCases: ['Virtual tours', 'Booking widgets', 'Concierge AI'] },
];
...
function generateFrameworkMapping(framework: Framework, category: FrameworkCategory): ContextToCapabilityMapping {
  ...
  return {
    ...
    recommendedModels: [
      { type: 'text', modelIds: ['gpt-4o', 'claude-sonnet-4-6', 'gemini-2.5-flash'], reason: `${framework.name} depth`, tier: framework.tier as 1 | 2 | 3 },
      { type: 'image', modelIds: ['flux-pro', 'gpt-image-1', 'modelslab-flux'], reason: 'Diagram quality', tier: 2 },
...
function generateVisualMapping(visual: ExpandedVisualFeature): ContextToCapabilityMapping {
  ...
  return {
    ...
    recommendedModels: [
      { type: 'image', modelIds: ['flux-pro', 'gpt-image-1', 'modelslab-flux', 'stable-diffusion-xl'], reason: visual.description, tier: visual.tier },
...
function generateOutputMapping(output: ExpandedOutputConfig): ContextToCapabilityMapping {
  ...
  return {
    ...
    recommendedModels: [
      { type: 'text', modelIds: ['gpt-4o', 'claude-sonnet-4-6', 'gemini-2.5-flash'], reason: 'Script quality', tier: output.tier },
      { type: 'image', modelIds: ['flux-pro', 'gpt-image-1', 'modelslab-flux', 'stable-diffusion-xl'], reason: output.description, tier: output.tier },
