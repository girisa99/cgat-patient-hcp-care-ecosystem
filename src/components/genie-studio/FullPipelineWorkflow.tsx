...
## Introduction
[Opening shot with ${mediaItems[0]?.name || 'title card'}]

Welcome to this comprehensive ${outputFormat.replace('_', ' ')} created from multiple sources.

## Section 1: Overview
Based on the content from ${sources[0]?.name || 'your sources'}, we begin with an overview...

${mediaItems.length > 1 ? `[Insert: ${mediaItems[1]?.name}]` : ''}

## Section 2: Deep Dive
Exploring the key concepts in detail...

## Section 3: Practical Applications
How these insights apply in real-world scenarios...

${mediaItems.length > 2 ? `[Insert: ${mediaItems[2]?.name}]` : ''}
