...
export const EXPANDED_OUTPUT_CONFIGS: ExpandedOutputConfig[] = [
  ...
  },
  {
    ...
    icon: 'Presentation',
    category: 'document',
    imageModels: ['gemini-image', 'modelslab-realvision', 'dall-e-3'],
    videoModels: [],
    mesh3dModels: [],
    voiceModels: [],
  ...
  },
  {
    ...
    icon: 'Image',
    category: 'static',
    imageModels: ['gemini-image', 'modelslab-realvision', 'stability-core', 'dall-e-3', 'flux-pro'],
    videoModels: [],
    mesh3dModels: [],
    voiceModels: [],
  ...
  },
  {
    ...
    icon: 'Printer',
    category: 'static',
    imageModels: ['flux-pro', 'midjourney-v6', 'dall-e-3'],
    videoModels: [],
    mesh3dModels: [],
    voiceModels: [],
  ...
  },
  {
    ...
    icon: 'Share2',
    category: 'static',
    imageModels: ['flux-pro', 'modelslab-flux', 'dall-e-3'],
    videoModels: ['modelslab-animatediff'],
    mesh3dModels: [],
    voiceModels: [],
  ...
  // ==========================================
  {
    ...
    mesh3dModels: [],
    voiceModels: ['elevenlabs', 'elevenlabs-ultra', 'azure-neural', 'alibaba-cosyvoice'],
  ...
  },
  {
    ...
    voiceModels: ['elevenlabs-ultra', 'alibaba-cosyvoice'],
