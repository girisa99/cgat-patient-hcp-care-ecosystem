 ...
 * Updated: Google OAuth support (Okta SSO requires Supabase Business plan)
 */
          ...
          {showGoogleSignIn && (
            <>
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 border-2 font-semibold text-sm hover:bg-muted/50 transition-all"
