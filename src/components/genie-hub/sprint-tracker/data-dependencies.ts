...
Key fields: phase, phaseProgress, overallProgress, artifacts[].`,
  ...
  // Lovable → Claude: Cast storage bucket must exist before uploads
  {
    ...
    consumerNotes: 'Claude\'s avatar pipeline (B-014) uploads generated videos to cast-assets/{user_id}/. Bucket provisioned with user-scoped RLS (INSERT/SELECT/UPDATE/DELETE). 100MB file limit. Allowed: video/mp4, video/webm, audio/mpeg, audio/wav, image/png, image/jpeg, image/webp.',
    status: 'ready',
    acknowledgedAt: '2026-02-21T14:00:00Z',
    priority: 'high',
  },
