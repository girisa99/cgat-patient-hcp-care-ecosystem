...
export const CleanUserManagementTable: React.FC = () => {
  ...
  // All other hooks must be called unconditionally BEFORE any early returns
  ...
  // ALL useMemo and useCallback hooks MUST be called unconditionally
    ...
    return (
      <Card className="m-6">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground">Fetching user data from master source</p>
        </CardContent>
      </Card>
    );
  }
