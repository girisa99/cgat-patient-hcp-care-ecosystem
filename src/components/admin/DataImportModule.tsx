...
export const DataImportModule: React.FC = () => {
  const { importCSVData, isLoading: csvLoading } = useDataImport();
  ...
  const downloadTemplate = (tableName: string) => {
    const templates: Record<string, string> = {
      ...
      services: 'name,service_type,description,capabilities,geographic_coverage,is_active\n"Cold Chain Logistics","3pl","Specialized cold chain management","Temperature monitoring;Real-time tracking","North America;Europe",true',
      service_providers: 'name,provider_type,specializations,geographic_coverage,certifications,is_active\n"Cryoport Systems","external_partner","Cold Chain;Cell & Gene Therapy","Global","GDP;IATA;ISPE",true'
    };
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>CSV/Excel Data Import</span>
              </CardTitle>
              <CardDescription>
                Import real market data from CSV or Excel files into specific database tables.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex space-x-2">
                <Button 
                  ...
                  className="flex-1"
                >
                  {isLoading ? 'Importing Data...' : 'Import Real Data'}
                </Button>
                <Button
                  variant="outline"
              ...
              {selectedTable && (
                <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-sm">
                      <p className="font-medium">Data Import Guidelines:</p>
                      <ul className="mt-1 text-xs space-y-1">
                        ...
                        <li>• Download the template to see the expected format for real data</li>
                      </ul>
                    </div>
                  </div>
                </div>
