/**
 * Popout Recording Studio - Audio Module Index
 * Exports all audio-related modules
 */

export { getAudioAnalyzerScript, getAudioAnalyzerStyles } from './audioAnalyzer';
export { getAudioTrimmerScript, getAudioTrimmerStyles } from './audioTrimmer';
export { getAudioExportScript, getAudioExportStyles } from './audioExport';
