...
import architectureImage from '@/assets/document-processing-architecture-v11.png';
  ...
  return (
    <Card className="w-full bg-background/80 backdrop-blur border-border">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <CardTitle className="text-foreground text-lg">Document Processing Platform Architecture</CardTitle>
      ...
      <CardContent className="p-4">
        <div className="relative w-full overflow-auto rounded-lg border border-border bg-white/95 dark:bg-slate-800/50">
          <img 
            ...
            className="w-full h-auto min-w-[800px] opacity-95"
          />
        </div>
