    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <Label>Known Medication Allergies *</Label>
            <div className="space-y-2">
              {(formData.medicationAllergies || []).map((allergy, index) => (
                <div key={index} className="flex gap-2">
                  <Input
                    value={allergy}
                    onChange={(e) => updateArrayItem('medicationAllergies', index, e.target.value)}
                  ...
                  {!readOnly && (
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      onClick={() => removeFromArray('medicationAllergies', index)}
                    >
                      <X className="h-4 w-4" />
                    </Button>
                  )}
              ...
              {!readOnly && (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => addToArray('medicationAllergies', '')}
                >
                  <Plus className="h-4 w-4 mr-2" />
                  Add Allergy
                </Button>
...
export const createEmptyCompleteClinicalData = (): CompleteClinicalTreatmentAssessment => ({
  ...
  medicationStartDates: [],
  medicationPrescribers: [],
  overTheCounterMeds: [],
  supplements: [],
  herbalRemedies: [],
  medicationAllergies: [],
  ...
  thrombosisRiskAssessment: '',
  bleedingRiskAssessment: '',
  priorTreatmentHistory: '',
  priorMedications: [],
  priorMedicationResponses: [],
  priorTherapies: [],
  priorTherapyOutcomes: [],
  priorSurgeries: [],
  priorProcedures: [],
  priorHospitalizations: [],
  priorERVisits: [],
  treatmentFailures: [],
  treatmentIntolerance: [],
  treatmentDiscontinuations: [],
  bestResponse: '',
  progressionDates: [],
  resistancePatterns: '',
  salvageTherapies: [],
