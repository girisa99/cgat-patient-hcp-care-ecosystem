  ...
  <TabsPrimitive.Trigger
    ...
    className={cn(
      level === 'parent'
        ...
        : "flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-foreground rounded-lg transition-all duration-200 hover:bg-background/60 hover:scale-105 border border-transparent ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary/20 data-[state=active]:shadow-md data-[state=active]:scale-105 min-w-fit",
      className
    )}
    {...props}
  />
