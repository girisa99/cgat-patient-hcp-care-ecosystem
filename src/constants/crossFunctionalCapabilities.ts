...
export const CROSS_FUNCTIONAL_CAPABILITIES: CrossFunctionalCapability[] = [
  ...
  // ============================================
  {
    ...
    primaryProviders: ['ElevenLabs', 'Azure', 'Alibaba CosyVoice'],
  ...
  },
  {
    ...
    primaryProviders: ['Suno AI', 'ModelsLab Audio'],
    fallbackProviders: [],
  ...
  },
  {
    ...
    primaryProviders: ['Azure STT', 'Google STT', 'Alibaba'],
    fallbackProviders: ['OpenAI Whisper'],
  ...
  // ============================================
  {
    ...
    tier: 'pro',
    compatibleProducts: ['vibe', 'deck', 'cast'],
    primaryProviders: ['ModelsLab', 'Alibaba Wan2.2'],
