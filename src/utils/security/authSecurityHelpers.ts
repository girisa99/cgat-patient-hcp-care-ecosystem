...
const validatePermissionWithRoles = async (userRoles: any[], action: string, resource: string): Promise<boolean> => {
  ...
  const permissionMap: Record<string, Record<string, string[]>> = {
    'read': {
      'users': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'patients': ['superAdmin', 'onboardingTeam', 'caseManager', 'nurse', 'provider', 'patientCaregiver', 'demoUser'],
      'facilities': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'modules': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'api-services': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'testing': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'security': ['superAdmin'],
      'role-management': ['superAdmin', 'demoUser'],
      'data-import': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'governance': ['superAdmin', 'demoUser'],
      'framework': ['superAdmin', 'demoUser'],
    ...
    'write': {
      'users': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'patients': ['superAdmin', 'onboardingTeam', 'caseManager', 'nurse', 'provider', 'demoUser'],
      'facilities': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'modules': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'api-services': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'testing': ['superAdmin', 'onboardingTeam', 'demoUser'],
    ...
    'delete': {
      'users': ['superAdmin', 'demoUser'],
      'patients': ['superAdmin', 'onboardingTeam', 'demoUser'],
      'facilities': ['superAdmin', 'demoUser'],
      'modules': ['superAdmin', 'demoUser'],
      'api-services': ['superAdmin', 'demoUser'],
      'testing': ['superAdmin', 'demoUser'],
      'security': ['superAdmin'],
      'role-management': ['superAdmin', 'demoUser'],
      'data-import': ['superAdmin', 'demoUser'],
      'governance': ['superAdmin', 'demoUser'],
      'framework': ['superAdmin', 'demoUser'],
