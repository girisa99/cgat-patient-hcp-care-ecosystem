...
// Import the main registry class
import { ModuleRegistry } from './moduleRegistry/ModuleRegistryClass';
import { ComponentServiceInfo, RegisteredModule, AutoRegistrationConfig, RegistryStats } from './moduleRegistry/types';
