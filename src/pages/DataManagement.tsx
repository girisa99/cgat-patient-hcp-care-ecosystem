    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Manage system data and infrastructure. For therapy and service selection, visit the dedicated <strong>Therapy Selection</strong> page.
        </p>
      </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Monitor and manage system-wide data integrity and health
              </p>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Card className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Regular backup and recovery monitoring
                  </p>
