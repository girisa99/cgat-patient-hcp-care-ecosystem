...
const Patients = () => {
  const { patients, isLoading, error, deactivatePatient, isDeactivating } = usePatients();
  ...
  const handleViewPatient = (patientId: string) => {
    // For now, just show a toast - in a real app, this would navigate to patient details
    toast({
      title: "View Patient",
  ...
  const handleEditPatient = (patientId: string) => {
    // For now, just show a toast - in a real app, this would open edit dialog
    toast({
      title: "Edit Patient",
