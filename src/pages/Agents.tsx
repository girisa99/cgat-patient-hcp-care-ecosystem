...
const AgentsInner = () => {
  ...
  // Don't redirect if we have prefillContext, autoGenerated, prefillPrompt, agentContext, or agentId
  useEffect(() => {
    const hasContext = agentContext || prefillContext || autoGenerated || locationState?.prefillPrompt || locationState?.agentId;
    if (!hasContext) {
  ...
  }, [agentContext, prefillContext, autoGenerated, locationState, navigate]);
