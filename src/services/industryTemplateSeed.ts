...
export const INDUSTRY_TEMPLATE_DEFINITIONS: IndustryTemplateDefinition[] = [
  ...
  // === CELEBRATIONS ===
  { id: 'wedding_traditional', label: 'Traditional Wedding', category: 'Celebrations', description: 'Traditional wedding ceremony with cultural customs', chapters: ['Title Reveal', 'Our Story', 'Ceremony Preview', 'Event Details', 'Closing Blessing'] },
  { id: 'wedding_destination', label: 'Destination Wedding', category: 'Celebrations', description: 'Destination wedding at scenic location', chapters: ['Destination Reveal', 'Our Journey', 'The Venue', 'Ceremony Preview', 'Closing Blessing'] },
  { id: 'wedding_fusion', label: 'Fusion / Multicultural Wedding', category: 'Celebrations', description: 'Multicultural wedding blending traditions', chapters: ['Title Reveal', 'Two Cultures', 'Our Story', 'Ceremony Blend', 'Event Details', 'Closing Blessing'] },
  { id: 'engagement_party', label: 'Engagement Party', category: 'Celebrations', description: 'Engagement announcement and party', chapters: ['Announcement', 'The Proposal', 'Celebration Details', 'Save the Date'] },
  { id: 'mehndi_henna', label: 'Mehndi / Henna Night', category: 'Celebrations', description: 'Mehndi/henna pre-wedding ceremony', chapters: ['Welcome', 'Henna Ceremony', 'Music & Dance', 'Event Details'] },
  { id: 'sangeet_night', label: 'Sangeet Night', category: 'Celebrations', description: 'Music and dance celebration before wedding', chapters: ['Welcome', 'Performances', 'Dance Floor', 'Event Details'] },
  { id: 'baby_shower', label: 'Baby Shower', category: 'Celebrations', description: 'Baby shower celebration', chapters: ['Welcome', 'Parent Story', 'Games & Activities', 'Event Details'] },
  { id: 'birthday_milestone', label: 'Milestone Birthday', category: 'Celebrations', description: 'Milestone birthday celebration (30th, 50th, etc.)', chapters: ['Welcome', 'Life Highlights', 'Tribute Messages', 'Party Details'] },
  { id: 'birthday_child', label: "Child's Birthday", category: 'Celebrations', description: "Child's birthday party invitation", chapters: ['Welcome', 'Birthday Theme', 'Activities', 'Party Details'] },
  { id: 'graduation_ceremony', label: 'Graduation', category: 'Celebrations', description: 'Graduation celebration', chapters: ['Congratulations', 'Journey', 'Ceremony Preview', 'Celebration Details'] },
  { id: 'retirement_party', label: 'Retirement', category: 'Celebrations', description: 'Retirement celebration and tribute', chapters: ['Career Highlights', 'Tribute Messages', 'Farewell', 'Celebration'] },
  { id: 'anniversary_celebration', label: 'Anniversary', category: 'Celebrations', description: 'Wedding anniversary celebration', chapters: ['Years Together', 'Memories', 'Celebration Details', 'Blessing'] },
  { id: 'housewarming', label: 'Housewarming', category: 'Celebrations', description: 'Housewarming / Griha Pravesh', chapters: ['Welcome', 'The New Home', 'Blessing', 'Party Details'] },
  { id: 'diwali_celebration', label: 'Diwali', category: 'Celebrations', description: 'Festival of Lights celebration', chapters: ['Greeting', 'Significance', 'Celebrations', 'Wishes'] },
  { id: 'eid_celebration', label: 'Eid', category: 'Celebrations', description: 'Eid al-Fitr or Eid al-Adha celebration', chapters: ['Eid Mubarak', 'Prayers', 'Feast', 'Wishes'] },
  { id: 'christmas_celebration', label: 'Christmas', category: 'Celebrations', description: 'Christmas greetings and celebration', chapters: ['Greeting', 'Nativity', 'Celebration', 'Wishes'] },
  { id: 'chinese_new_year', label: 'Chinese New Year', category: 'Celebrations', description: 'Lunar New Year celebration', chapters: ['Greeting', 'Zodiac', 'Traditions', 'Wishes'] },
  { id: 'nowruz_celebration', label: 'Nowruz', category: 'Celebrations', description: 'Persian / Central Asian New Year', chapters: ['Greeting', 'Haft Sin', 'Spring', 'Wishes'] },
  { id: 'navratri_celebration', label: 'Navratri', category: 'Celebrations', description: 'Nine Nights of worship and dance', chapters: ['Greeting', 'Nine Nights', 'Garba', 'Wishes'] },
  { id: 'holi_celebration', label: 'Holi', category: 'Celebrations', description: 'Festival of Colors', chapters: ['Greeting', 'Colors', 'Celebration', 'Wishes'] },
  { id: 'baptism_ceremony', label: 'Baptism / Christening', category: 'Celebrations', description: 'Christian baptism ceremony', chapters: ['Welcome', 'Ceremony', 'Blessing', 'Celebration'] },
  { id: 'bar_bat_mitzvah', label: 'Bar/Bat Mitzvah', category: 'Celebrations', description: 'Jewish coming-of-age ceremony', chapters: ['Welcome', 'Torah Reading', 'Speech', 'Celebration', 'Party'] },
  { id: 'quinceanera', label: 'Quinceañera', category: 'Celebrations', description: 'Latin American 15th birthday', chapters: ['Welcome', 'Church Ceremony', 'Waltz', 'Party', 'Toast'] },
  { id: 'corporate_gala', label: 'Corporate Gala', category: 'Celebrations', description: 'Corporate gala dinner', chapters: ['Welcome', 'Keynote', 'Awards', 'Networking', 'Closing'] },
  { id: 'award_ceremony', label: 'Award Ceremony', category: 'Celebrations', description: 'Award ceremony and recognition', chapters: ['Opening', 'Nominees', 'Awards', 'Acceptance', 'Closing'] },
  { id: 'inauguration', label: 'Grand Opening / Inauguration', category: 'Celebrations', description: 'Inauguration or grand opening event', chapters: ['Welcome', 'Vision', 'Ribbon Cutting', 'Tour', 'Celebration'] },
  { id: 'game_day_party', label: 'Game Day Party', category: 'Celebrations', description: 'Sports game day watch party', chapters: ['Team Intro', 'Matchup', 'Party Details', 'Lets Go'] },
  { id: 'memorial_tribute', label: 'Memorial / Tribute', category: 'Celebrations', description: 'Memorial service or celebration of life', chapters: ['Tribute Opening', 'Life Story', 'Memories', 'Tribute Messages', 'Closing'] },
  { id: 'naming_ceremony', label: 'Naming Ceremony', category: 'Celebrations', description: 'Baby naming ceremony', chapters: ['Welcome', 'Name Reveal', 'Blessing', 'Celebration'] },
  { id: 'thanksgiving_gathering', label: 'Thanksgiving', category: 'Celebrations', description: 'Thanksgiving celebration', chapters: ['Gratitude', 'Family Gathering', 'Feast', 'Wishes'] },
  { id: 'vow_renewal', label: 'Vow Renewal', category: 'Celebrations', description: 'Wedding vow renewal ceremony', chapters: ['Title Reveal', 'Our Journey Together', 'Ceremony Renewal', 'Event Details', 'Closing Blessing'] },
  { id: 'gender_reveal', label: 'Gender Reveal', category: 'Celebrations', description: 'Gender reveal announcement', chapters: ['Intro', 'Suspense', 'The Reveal', 'Celebration'] },
  { id: 'couples_story_podcast', label: 'Couples Story Podcast', category: 'Celebrations', description: 'Love story podcast episode', chapters: ['Intro', 'How They Met', 'The Proposal', 'Cultural Traditions', 'Family Voices', 'Invitation & Close'] },
  { id: 'ceremony_webcast', label: 'Ceremony Webcast', category: 'Celebrations', description: 'Live or recorded ceremony webcast', chapters: ['Pre-Show', 'Ceremony', 'Celebration', 'Farewell'] },
  { id: 'wedding_interfaith', label: 'Interfaith Wedding', category: 'Celebrations', description: 'Interfaith wedding blending two religious traditions', chapters: ['Title Reveal', 'Two Traditions', 'Our Story', 'Ceremony Blend', 'Event Details', 'Closing Blessing'] },
  { id: 'wedding_elopement', label: 'Elopement', category: 'Celebrations', description: 'Intimate elopement ceremony', chapters: ['Announcement', 'Our Story', 'The Moment', 'Celebration'] },
  { id: 'rehearsal_dinner', label: 'Rehearsal Dinner', category: 'Celebrations', description: 'Pre-wedding rehearsal dinner', chapters: ['Welcome', 'Toasts', 'Memories', 'Details'] },
  { id: 'honeymoon_video', label: 'Honeymoon', category: 'Celebrations', description: 'Honeymoon travel video', chapters: ['Departure', 'Destination', 'Adventures', 'Romance'] },
  { id: 'upanayanam_ceremony', label: 'Upanayanam', category: 'Celebrations', description: 'Hindu sacred thread ceremony', chapters: ['Welcome', 'Rituals', 'Sacred Thread', 'Blessing'] },
  { id: 'aqeeqah_ceremony', label: 'Aqeeqah', category: 'Celebrations', description: 'Islamic birth celebration', chapters: ['Welcome', 'Naming', 'Feast', 'Blessing'] },
  { id: 'first_communion', label: 'First Communion', category: 'Celebrations', description: 'Catholic First Holy Communion', chapters: ['Welcome', 'Church Ceremony', 'Eucharist', 'Celebration'] },
  { id: 'confirmation_ceremony', label: 'Confirmation', category: 'Celebrations', description: 'Christian confirmation ceremony', chapters: ['Welcome', 'Ceremony', 'Affirmation', 'Celebration'] },
  { id: 'amrit_sanchar', label: 'Amrit Sanchar', category: 'Celebrations', description: 'Sikh baptism ceremony', chapters: ['Welcome', 'Prayers', 'Amrit', 'Blessing'] },
  { id: 'janoi_ceremony', label: 'Janoi', category: 'Celebrations', description: 'Brahmin sacred thread ceremony', chapters: ['Welcome', 'Rituals', 'Sacred Thread', 'Feast'] },
  { id: 'eid_al_adha', label: 'Eid al-Adha', category: 'Celebrations', description: 'Festival of Sacrifice', chapters: ['Eid Mubarak', 'Prayers', 'Sacrifice', 'Feast', 'Wishes'] },
  { id: 'hanukkah_celebration', label: 'Hanukkah', category: 'Celebrations', description: 'Festival of Lights (Jewish)', chapters: ['Happy Hanukkah', 'Menorah', 'Traditions', 'Wishes'] },
  { id: 'easter_celebration', label: 'Easter', category: 'Celebrations', description: 'Easter celebration', chapters: ['Happy Easter', 'Resurrection', 'Traditions', 'Wishes'] },
  { id: 'onam_celebration', label: 'Onam', category: 'Celebrations', description: 'Kerala harvest festival', chapters: ['Welcome', 'Pookalam', 'Sadya', 'Boat Race', 'Wishes'] },
  { id: 'pongal_celebration', label: 'Pongal', category: 'Celebrations', description: 'Tamil harvest festival', chapters: ['Greeting', 'Bhogi', 'Thai Pongal', 'Mattu Pongal', 'Wishes'] },
  { id: 'vesak_celebration', label: 'Vesak', category: 'Celebrations', description: 'Buddhist celebration of Buddha', chapters: ['Greeting', 'Birth', 'Enlightenment', 'Parinirvana', 'Wishes'] },
  { id: 'songkran_celebration', label: 'Songkran', category: 'Celebrations', description: 'Thai New Year water festival', chapters: ['Greeting', 'Water Blessing', 'Celebration', 'Wishes'] },
  { id: 'team_celebration', label: 'Team Celebration', category: 'Celebrations', description: 'Team achievement or milestone celebration', chapters: ['Welcome', 'The Journey', 'Achievements', 'Recognition', 'Cheers'] },
  { id: 'milestone_celebration', label: 'Company Milestone', category: 'Celebrations', description: 'Corporate milestone (anniversary, 1M users, IPO)', chapters: ['Welcome', 'Origin Story', 'Growth', 'Milestone Reveal', 'Future Vision'] },
  { id: 'tournament_event', label: 'Tournament', category: 'Celebrations', description: 'Sports tournament or league event', chapters: ['Intro', 'Teams', 'Bracket', 'Highlights', 'Champion'] },
