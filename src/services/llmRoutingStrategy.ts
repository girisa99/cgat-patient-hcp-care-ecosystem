...
export const COMPLETE_ROUTING_TABLE: RegionRoute[] = [
  ...
  { region: 'Saudi Arabia', countryCode: 'SA', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: '⭐ Najdi dialect', reason: 'GPT-4o best for Arabic per AraBench + Azure for 7 Arabic dialects' } },
  { region: 'UAE', countryCode: 'AE', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: '⭐ Gulf dialect', reason: 'GPT-4o + Gulf Arabic dialect support' } },
  { region: 'Egypt', countryCode: 'EG', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: '⭐ Egyptian dialect', reason: 'GPT-4o best for Egyptian Arabic dialect' } },
  { region: 'Morocco', countryCode: 'MA', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Maghrebi dialect', reason: 'GPT-4o + Maghrebi dialect' } },
  { region: 'Algeria', countryCode: 'DZ', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Maghrebi dialect', reason: 'GPT-4o + Algerian dialect' } },
  { region: 'Iraq', countryCode: 'IQ', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Iraqi dialect', reason: 'GPT-4o + Iraqi dialect' } },
  { region: 'Jordan', countryCode: 'JO', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Levantine dialect', reason: 'GPT-4o + Levantine dialect' } },
  { region: 'Lebanon', countryCode: 'LB', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Levantine dialect', reason: 'GPT-4o + Levantine dialect' } },
  { region: 'Kuwait', countryCode: 'KW', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Gulf dialect', reason: 'GPT-4o + Gulf Arabic' } },
  { region: 'Qatar', countryCode: 'QA', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Gulf dialect', reason: 'GPT-4o + Gulf Arabic' } },
  { region: 'Bahrain', countryCode: 'BH', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Gulf dialect', reason: 'GPT-4o + Gulf Arabic' } },
  { region: 'Oman', countryCode: 'OM', zone: 'arabic', config: { llm: 'gpt-4o', llmFallback: 'claude-3-5-sonnet', tts: 'azure-neural', stt: 'whisper', translation: 'azure-translator', rtl: true, moat: 'Gulf dialect', reason: 'GPT-4o + Gulf Arabic' } },
