...
const ATOMIC_STEPS: Record<string, PipelineStep> = {
  ...
  voice_clone: {
    ...
    creditMultiplier: 2,
    config: { mode: 'voice_clone', api: 'voice-lab' },
  },
  ...
  image_generate: {
    ...
    description: 'Generate images from text prompts or style references',
    edgeFunction: 'gemini-generate-image',
    inputType: 'prompt',
    outputType: 'image',
    optional: true,
    estimatedDuration: 15,
    creditMultiplier: 1,
    config: { fallback: 'ai-image-generator' },
  },
  image_to_image: {
    id: 'image_to_image',
    name: 'Image-to-Image Transform',
    description: 'Transform source images with style or edits',
  ...
  // 3D / Animation
  pixar_3d_generate: {
    id: 'pixar_3d_generate',
    name: 'Pixar 3D Render',
    description: 'Generate Pixar-style 3D renderings from scene descriptions',
    edgeFunction: 'alibaba-3d-generator',
    inputType: 'scene_description',
    outputType: '3d_render',
    optional: true,
    estimatedDuration: 60,
    creditMultiplier: 3,
    config: { style: 'pixar', fallback_provider: 'meshy-3d' },
  },
  cartoon_animate: {
    id: 'cartoon_animate',
    name: 'Cartoon Animation',
    description: 'Generate cartoon-style animated sequences',
    edgeFunction: 'alibaba-video-generator',
    inputType: 'storyboard',
  ...
  scene_3d_generate: {
    id: 'scene_3d_generate',
    name: '3D Scene Generation',
    description: 'Generate complete 3D scenes from descriptions',
    edgeFunction: 'alibaba-3d-generator',
    inputType: 'scene_description',
    outputType: '3d_scene',
    optional: true,
  ...
  style_transfer: {
    id: 'style_transfer',
    name: 'Style Transfer',
    description: 'Apply artistic style transfer to images or video frames',
    edgeFunction: 'ai-image-generator',
    action: 'style_transfer',
    inputType: 'image',
    outputType: 'styled_image',
    optional: true,
    estimatedDuration: 20,
    creditMultiplier: 1.5,
  },
  diff_animate: {
    id: 'diff_animate',
    name: 'Diffusion Animation',
    description: 'Animate still images using diffusion models',
    edgeFunction: 'alibaba-video-generator',
    action: 'animate',
    inputType: 'image',
    outputType: 'animation',
  ...
  green_screen: {
    id: 'green_screen',
    name: 'Green Screen / BG Remove',
    description: 'Remove or replace video/image backgrounds',
    edgeFunction: 'ai-image-generator',
    action: 'remove_background',
    inputType: 'video',
    outputType: 'composited_video',
    optional: true,
    estimatedDuration: 15,
    creditMultiplier: 1,
  },
  ...
  dubbing_generate: {
    id: 'dubbing_generate',
    name: 'AI Dubbing',
    description: 'Generate dubbed audio in target languages with emotion preservation',
    edgeFunction: 'elevenlabs-voice',
    inputType: 'script_audio',
    outputType: 'dubbed_audio',
    optional: true,
    estimatedDuration: 40,
    creditMultiplier: 2,
    config: { mode: 'dubbing', preserve_emotion: true },
  },
  ...
  brand_watermark: {
    ...
    description: 'Overlay brand watermark and C2PA provenance metadata',
    edgeFunction: 'ai-universal-processor',
    action: 'watermark_overlay',
    inputType: 'video',
    outputType: 'watermarked_video',
    optional: true,
    estimatedDuration: 5,
  ...
  subtitle_burn: {
    ...
    description: 'Burn subtitle text into video frames',
    edgeFunction: 'ai-universal-processor',
    action: 'burn_subtitles',
    inputType: 'video_captions',
    outputType: 'subtitled_video',
    optional: true,
    estimatedDuration: 15,
    creditMultiplier: 0.5,
  },
