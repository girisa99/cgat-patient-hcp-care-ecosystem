  ...
  private getFallbackScript(productId: GenieProductId, languageCode: string): string {
    ...
    const scripts: Record<string, Record<GenieProductId, string>> = {
      en: {
        ...
        arc: `Genie Hub is your creative command center for project scheduling and asset management.`,
        studio: `Genie Suite: Seven products, 206 pipelines, your creative vision realized.`,
