...
const CAPABILITY_ZONE_ROUTING: Record<LLMZone, Record<PipelineCapability, DynamicProviderRoute>> = {
  ...
  alibaba: {
    llm: { primary: 'alibaba', fallback: 'openai', zone: 'alibaba', quality: 5, reason: 'Qwen-Max for CJK/Arabic' },
    ...
    translation: { primary: 'alibaba', fallback: 'deepseek', zone: 'alibaba', quality: 5, reason: 'Qwen-MT for CJK' },
    tts: { primary: 'alibaba', fallback: 'azure', zone: 'alibaba', quality: 5, reason: 'CosyVoice for CJK' },
    stt: { primary: 'alibaba', fallback: 'openai', zone: 'alibaba', quality: 5, reason: 'Paraformer for CJK' },
    voice_clone: { primary: 'alibaba', fallback: 'elevenlabs', zone: 'alibaba', quality: 4, reason: 'Alibaba voice clone' },
    ...
    image_gen: { primary: 'alibaba', fallback: 'modelslab', zone: 'alibaba', quality: 5, reason: 'Alibaba Wanx for CJK' },
    video_gen: { primary: 'alibaba', fallback: 'modelslab', zone: 'alibaba', quality: 5, reason: 'WAN 2.2 for CJK video' },
    avatar: { primary: 'alibaba', fallback: 'replicate', zone: 'alibaba', quality: 5, reason: 'Alibaba WAN 2.2' },
    lip_sync: { primary: 'alibaba', fallback: 'azure', zone: 'alibaba', quality: 5, reason: 'Alibaba lip-sync' },
