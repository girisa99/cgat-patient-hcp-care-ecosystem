...
export const PRODUCT_KNOWLEDGE = {
  ...
  arc: {
    ...
    description: 'Central management dashboard with 15+ modules: Kanban, calendar, team, whitelabel, analytics, AI intelligence, command center, content scheduling, composition studio, and workspace management. Formerly known as Arc/Admin.',
    pipelineCount: PRODUCT_PIPELINE_SUMMARY.arc.totalAccess,
    categories: ['scheduling', 'collaboration'],
    editorMode: 'canvas',
    wizardSteps: [],
    capabilities: ['Kanban Board', 'Calendar', 'Content Scheduler', 'Team Management', 'Workspaces', 'Whitelabel Branding', 'Analytics', 'AI Intelligence', 'Command Center', 'Composition Studio', 'Content Library', 'Error Analytics', 'Enterprise Analytics', 'Collaboration'],
  },
  cast: {
    id: 'cast',
    name: 'Genie Cast',
    tagline: 'Make It. Show It. Scale It.',
    description: 'End-to-end video production pipeline: CREATE (scenes, styles, prompts, 16 regions) → PRODUCE (AI generation, GPU rendering, assembly) → PUBLISH (multi-platform distribution, scheduling, analytics). Supports 85+ languages, 19+ AI providers, 4 AI zones.',
    pipelineCount: PRODUCT_PIPELINE_SUMMARY.cast.totalAccess,
    categories: ['distribution', 'marketing', 'analytics'],
    editorMode: 'canvas',
    wizardSteps: [8],
    capabilities: ['Scene Composition', 'Style Selection', 'Prompt Enhancement', 'GPU Rendering', 'Video Assembly', 'Caption Burning', 'Audio Mixing', 'Multi-platform Publishing', '16-Region Localization', 'Content Repurposing', 'A/B Testing', 'Smart Scheduling', 'Social Publishing', 'Analytics Dashboard', 'Podcast Production', 'Dialogue Generation'],
  },
  studio: {
    id: 'studio',
    name: 'Genie Suite',
