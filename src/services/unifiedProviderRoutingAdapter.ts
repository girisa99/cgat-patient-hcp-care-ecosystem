...
const LLM_PROVIDER_MAP: Record<string, { primary: string; fallback: string; zone: LLMZone; quality: number }> = {
  ...
  'hi': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 5 },
  'bn': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 5 },
  'te': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 5 },
  'ta': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 5 },
  'mr': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'gu': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'kn': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'ml': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'pa': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'ur': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'id': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'vi': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'th': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'fil': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'ms': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'sw': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 5 },
  'yo': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'ha': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 3 },
  'ig': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 3 },
  'am': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
  'zu': { primary: 'gemini-2.5-pro', fallback: 'gpt-4o', zone: 'gemini', quality: 4 },
};
