...
export const SCRIPT_TEMPLATES: Record<string, ScriptTemplate> = {
  ...
  // ─── CELEBRATION (weddings, milestones, birthdays) ──────────
  celebration: {
    id: 'celebration',
    format: 'celebration',
    name: 'Celebration',
    description: 'Weddings, birthdays, milestones, and personal celebrations',
    defaultTone: 'celebratory',
    durationRange: { min: 60, max: 600 },
    minSpeakers: 1,
    guidelines: [
      'Emotional, personal, heartfelt',
      'Montage-heavy with music-forward sections',
      'Include personal messages and memories',
      'Build to an emotional climax',
      'End with warmth and well-wishes',
    ],
    beats: [
      {
        name: 'Opening Moment',
        purpose: 'Set the emotional tone with a beautiful opening',
        sceneType: 'title-card',
        durationRatio: 0.10,
        tone: 'empathetic',
        contentGuide: 'Elegant title with date, names, and a warm message',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 2,
      },
      {
        name: 'Memory Montage',
        purpose: 'Walk through cherished memories and moments',
        sceneType: 'montage-reel',
        durationRatio: 0.25,
        tone: 'nostalgic',
        contentGuide: 'Photo/video montage of key moments, narrated or music-only',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 3,
      },
      {
        ...
        purpose: 'Heartfelt messages from loved ones',
        sceneType: 'testimonial',
        durationRatio: 0.25,
        tone: 'empathetic',
        contentGuide: 'Personal dedications, toasts, wishes from family and friends',
        requiresSpeaker: true,
        minLines: 2,
        maxLines: 5,
      },
      {
        name: 'Highlight Reel',
        purpose: 'Best moments compilation',
        sceneType: 'montage-reel',
        durationRatio: 0.25,
        tone: 'celebratory',
        contentGuide: 'High-energy best moments, music-forward, cinematic cuts',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 2,
      },
      {
        name: 'Farewell',
        purpose: 'Warm closing with well-wishes',
        sceneType: 'cta-outro',
        durationRatio: 0.15,
        tone: 'empathetic',
        contentGuide: 'Thank you message, well-wishes, sentimental close',
        requiresSpeaker: true,
        minLines: 1,
        maxLines: 2,
      },
  ...
  // ─── EVENT RECAP (conferences, launches, meetups) ──────────
  'event-recap': {
    id: 'event-recap',
    format: 'event-recap',
    name: 'Event Recap',
    description: 'Conference highlights, launch events, trade shows, meetups',
    defaultTone: 'inspiring',
    durationRange: { min: 60, max: 600 },
    minSpeakers: 1,
    guidelines: [
      'Fast-paced and energetic',
      'Show the scale and atmosphere',
      'Include speaker highlights and audience reactions',
      'Data points: attendance, impact numbers',
      'End with forward-looking CTA',
    ],
    beats: [
      {
        name: 'Event Opener',
        purpose: 'Capture the energy and scale of the event',
        sceneType: 'title-card',
        durationRatio: 0.10,
        tone: 'dramatic',
        contentGuide: 'Event name, date, location — dynamic reveal',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 2,
      },
      {
        name: 'Atmosphere',
        purpose: 'Show the venue, crowd, and energy',
        sceneType: 'montage-reel',
        durationRatio: 0.20,
        tone: 'inspiring',
        contentGuide: 'Quick cuts of venue, crowds, setup, brand activations',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 3,
      },
      {
        name: 'Key Moments',
        purpose: 'Highlight speakers and keynote moments',
        sceneType: 'talking-head',
        durationRatio: 0.25,
        tone: 'authoritative',
        contentGuide: 'Speaker clips, key announcements, panel highlights',
        requiresSpeaker: true,
        minLines: 2,
        maxLines: 5,
      },
      {
        name: 'Attendee Voices',
        purpose: 'Reactions and testimonials from attendees',
        sceneType: 'testimonial',
        durationRatio: 0.20,
        tone: 'conversational',
        contentGuide: 'Quick sound bites from attendees about their experience',
        requiresSpeaker: true,
        minLines: 2,
        maxLines: 4,
      },
      {
        name: 'Impact & Stats',
        purpose: 'Key numbers and impact data',
        sceneType: 'data-viz-narrative',
        durationRatio: 0.10,
        tone: 'authoritative',
        contentGuide: 'Attendance numbers, engagement stats, key outcomes',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 2,
      },
      {
        name: 'Next Event CTA',
        purpose: 'Drive interest in the next event',
        sceneType: 'cta-outro',
        durationRatio: 0.15,
        tone: 'inspiring',
        contentGuide: 'Save the date, register now, join the community',
        requiresSpeaker: true,
        minLines: 1,
        maxLines: 2,
      },
  ...
  // ─── VIRTUAL TOUR (real estate, hospitality, locations) ────
  'virtual-tour': {
    id: 'virtual-tour',
    format: 'virtual-tour',
    name: 'Virtual Tour',
    description: 'Property tours, hotel walkthroughs, destination showcases',
    defaultTone: 'conversational',
    durationRange: { min: 60, max: 600 },
    minSpeakers: 1,
    guidelines: [
      ...
      'Narrate benefits, not just descriptions',
      'Show scale and atmosphere',
      'End with clear booking/inquiry CTA',
    ],
    beats: [
      {
        name: 'Arrival',
        purpose: 'First impression — exterior or aerial establishing shot',
        sceneType: 'b-roll-narration',
        durationRatio: 0.15,
        tone: 'inspiring',
        contentGuide: 'Beautiful exterior shot, neighborhood context, first impression',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 3,
      },
      {
        name: 'Guided Tour',
        purpose: 'Walk through key spaces with narration',
        sceneType: 'talking-head',
        durationRatio: 0.35,
        tone: 'conversational',
        contentGuide: 'Room-by-room walkthrough highlighting features, finishes, and layout',
        requiresSpeaker: true,
        minLines: 3,
        maxLines: 8,
      },
      {
        ...
        purpose: 'Show amenities and lifestyle benefits',
        sceneType: 'b-roll-narration',
        durationRatio: 0.25,
        tone: 'inspiring',
        contentGuide: 'Pool, gym, views, kitchen, garden — lifestyle-focused shots',
        requiresSpeaker: false,
        minLines: 2,
        maxLines: 4,
      },
      {
        ...
        purpose: 'Close-up details that sell the space',
        sceneType: 'b-roll-narration',
        durationRatio: 0.15,
        tone: 'empathetic',
        contentGuide: 'Material details, smart home features, unique design elements',
        requiresSpeaker: false,
        minLines: 1,
        maxLines: 3,
      },
      {
        name: 'Contact & CTA',
        purpose: 'Drive inquiry or booking',
        sceneType: 'cta-outro',
        durationRatio: 0.10,
        tone: 'conversational',
        contentGuide: 'Contact info, pricing, schedule a visit, or book now',
        requiresSpeaker: true,
        minLines: 1,
        maxLines: 2,
      },
