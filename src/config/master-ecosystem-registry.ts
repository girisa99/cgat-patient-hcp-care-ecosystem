...
export const MASTER_AI_PROVIDERS: AIProviderEntry[] = [
  ...
  },
  {
    ...
    qualityScore: 95,
    speedScore: 85,
    strengths: ['FFmpeg-based assembly', 'GPU-accelerated', 'Multi-layer composition', 'Custom transitions', 'No duration limit'],
    models: ['cast-ffmpeg-renderer'],
    wiredToGenieCast: true,
  },
  {
    id: 'flux',
...
export const MASTER_MARKETING_PIPELINES: PipelineEntry[] = [
  ...
  { id: 'video-trim', name: 'Video Trim', category: 'video', description: 'Trim video clips', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 74 },
  { id: 'video-merge', name: 'Video Merge', category: 'video', description: 'Merge multiple videos', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 75 },
  { id: 'video-split', name: 'Video Split', category: 'video', description: 'Split video into segments', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 76 },
  { id: 'video-transitions', name: 'Video Transitions', category: 'video', description: 'Add transitions between clips', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 77 },
  { id: 'video-overlay', name: 'Video Overlay', category: 'video', description: 'Add overlays to video', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 78 },
  { id: 'video-text-overlay', name: 'Video Text Overlay', category: 'video', description: 'Add text overlays', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 79 },
  { id: 'video-logo-overlay', name: 'Video Logo Overlay', category: 'video', description: 'Add logo watermarks', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 80 },
  ...
  { id: 'video-speed-change', name: 'Video Speed Change', category: 'video', description: 'Adjust video speed', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 82 },
  { id: 'video-resize', name: 'Video Resize', category: 'video', description: 'Resize video dimensions', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 83 },
  ...
  { id: 'audio-mix', name: 'Audio Mix', category: 'audio', description: 'Mix multiple audio tracks', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 85 },
  { id: 'audio-normalize', name: 'Audio Normalize', category: 'audio', description: 'Normalize audio levels', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 86 },
  { id: 'audio-ducking', name: 'Audio Ducking', category: 'audio', description: 'Auto-duck background audio', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 87 },
  ...
  { id: 'audio-sync', name: 'Audio Sync', category: 'audio', description: 'Sync audio to video', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 89 },
  { id: 'voiceover-overlay', name: 'Voiceover Overlay', category: 'audio', description: 'Add voiceover to video', providers: ['elevenlabs', 'azure', 'runpod-ffmpeg'], tabMapping: 'PRODUCE', isActive: true, priority: 90 },
  { id: 'podcast-to-video', name: 'Podcast to Video', category: 'video', description: 'Convert podcast to video', providers: ['modelslab', 'alibaba', 'runpod-ffmpeg'], tabMapping: 'PRODUCE', isActive: true, priority: 91 },
  { id: 'webinar-recorder', name: 'Webinar Recorder', category: 'video', description: 'Record and process webinars', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 92 },
  ...
  { id: 'multi-host-video', name: 'Multi-Host Video', category: 'video', description: 'Multi-person video layout', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 94 },
  ...
  { id: 'audiogram-generator', name: 'Audiogram Generator', category: 'social', description: 'Create social audiograms', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 99 },
  { id: 'podcast-teaser', name: 'Podcast Teaser', category: 'social', description: 'Create podcast teaser clips', providers: ['modelslab', 'runpod-ffmpeg'], tabMapping: 'PRODUCE', isActive: true, priority: 100 },
  ...
  { id: 'video-shorts', name: 'Video Shorts', category: 'social', description: 'Generate short-form content', providers: ['modelslab', 'gemini', 'runpod-ffmpeg'], tabMapping: 'MANAGE', isActive: true, priority: 105 },
  ...
  { id: 'dub-sync', name: 'Dub Sync', category: 'audio', description: 'Sync dubbed audio to video', providers: ['runpod-ffmpeg', 'elevenlabs'], tabMapping: 'PRODUCE', isActive: true, priority: 119 },
  ...
  { id: 'caption-burner', name: 'Caption Burner', category: 'video', description: 'Burn captions into video', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 121 },
  ...
  { id: 'video-reverse', name: 'Video Reverse', category: 'video', description: 'Reverse video playback', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 123 },
  { id: 'video-crop', name: 'Video Crop', category: 'video', description: 'Crop video frame', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 124 },
  { id: 'video-rotate', name: 'Video Rotate', category: 'video', description: 'Rotate video', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 125 },
  { id: 'video-preview', name: 'Video Preview', category: 'video', description: 'Generate video previews', providers: ['modelslab', 'runpod-ffmpeg'], tabMapping: 'MANAGE', isActive: true, priority: 126 },
  { id: 'audio-fade', name: 'Audio Fade', category: 'audio', description: 'Add fade in/out effects', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 127 },
  { id: 'audio-replace', name: 'Audio Replace', category: 'audio', description: 'Replace video audio track', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 128 },
  { id: 'audio-compression', name: 'Audio Compression', category: 'audio', description: 'Compress audio dynamics', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 129 },
  { id: 'audio-eq', name: 'Audio EQ', category: 'audio', description: 'Equalize audio frequencies', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 130 },
  { id: 'live-stream-processor', name: 'Live Stream Processor', category: 'video', description: 'Process live stream recordings', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'MANAGE', isActive: true, priority: 131 },
  ...
  { id: 'slide-to-video', name: 'Slide to Video', category: 'video', description: 'Convert slides to video', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 141 },
  { id: 'animated-slides', name: 'Animated Slides', category: 'presentation', description: 'Add slide animations', providers: ['runpod-ffmpeg', 'modelslab'], tabMapping: 'PRODUCE', isActive: true, priority: 142 },
  ...
  { id: '3d-to-video', name: '3D to Video', category: '3d_vr_ar', description: 'Render 3D to video', providers: ['meshy', 'modelslab', 'runpod-ffmpeg'], tabMapping: 'PRODUCE', isActive: true, priority: 161 },
