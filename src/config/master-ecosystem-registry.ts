...
export const MASTER_AI_PROVIDERS: AIProviderEntry[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    qualityScore: 88,
    speedScore: 85,
    strengths: ['CJK optimized', 'WAN 2.6 video', 'CosyVoice TTS', 'Paraformer STT', 'Avatar S2V', 'TaoAvatar'],
    models: ['qwen-max', 'qwen-2.5-72b', 'wan2.6-t2v', 'wan2.6-i2v', 'wan2.2-s2v', 'cosyvoice', 'paraformer', 'tao-avatar'],
    wiredToGenieCast: true,
  },
  {
    id: 'azure',
  ...
  },
  {
    ...
    models: ['cosyvoice-v1', 'cosyvoice-clone'],
    wiredToGenieCast: true,
  },
  {
    id: 'paraformer',
...
export const MASTER_MARKETING_PIPELINES: PipelineEntry[] = [
  ...
  { id: 'voice-cloning', name: 'Voice Cloning', category: 'audio', description: 'Clone and generate custom voices', providers: ['elevenlabs', 'cosyvoice'], tabMapping: 'PRODUCE', isActive: true, priority: 37 },
  ...
  { id: 'emotion-tts', name: 'Emotion TTS', category: 'audio', description: 'TTS with emotional expression', providers: ['elevenlabs', 'azure', 'cosyvoice'], tabMapping: 'PRODUCE', isActive: true, priority: 39 },
  ...
  { id: 'cjk-tts', name: 'CJK TTS', category: 'audio', description: 'Specialized TTS for CJK languages', providers: ['cosyvoice', 'alibaba', 'azure'], tabMapping: 'PRODUCE', isActive: true, priority: 45 },
