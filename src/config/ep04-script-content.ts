...
But nobody ever said: what if the system itself was the problem?`,
  ...
  'scene1-market-data': {
    ...
    links: [
      ...
      { label: '📎 Microsoft Research — Restoring Focus After Interruptions', url: 'https://www.microsoft.com/en-us/research/publication/the-cost-of-interrupted-work-more-speed-and-stress/', type: 'research' },
