...
const southAsiaConfig: RegionalConfig = {
  hero: {
    ...
    theme: 'Himalayan Heart',
    englishHeadline: 'From the Himalayas to the Indian Ocean — Your Languages, Your Way.',
    englishSubheadline: 'Nepali, Sinhala, Dzongkha, Dhivehi — languages the world overlooks, but we celebrate.',
    nativeHeadline: 'नेपाली, සිංහල, རྫོང་ཁ — तपाईंको भाषा, तपाईंको आवाज',
    nativeSubheadline: 'हिमालदेखि समुद्रसम्म — हरेक भाषामा सृजना',
  },
  ...
  differentiators: {
    heroBadge: 'South Asia\'s Overlooked Voices — Amplified',
    firstToMarket: ['Nepali AI that writes like a Nepali — not a Hindi speaker guessing', 'Sinhala & Tamil dual-script for Sri Lanka — both communities, one platform', 'Dzongkha support — Bhutan\'s language, respected and rendered'],
    capabilityDepth: ['Dashain, Vesak, Tshechu festival-aware content calendar', 'Tourism content for Maldives luxury + Nepal trekking + Sri Lanka heritage', 'Low-bandwidth optimization for rural Nepal and Sri Lanka'],
    onlyHere: ['True South Asian transcreation — not Indian content repackaged', 'From Himalayan resilience to island serenity — every culture, every tone'],
  },
  languageShowcase: {
    languages: [
      { code: 'ne-NP', name: 'Nepali', nativeName: 'नेपाली', flag: '🇳🇵', transcreation: 'मिनेटमा हृदयलाई छुने सामग्री', literal: 'मिनेटमा अचम्मको सामग्री बनाउनुहोस्' },
      { code: 'si-LK', name: 'Sinhala', nativeName: 'සිංහල', flag: '🇱🇰', transcreation: 'මිනිත්තු කිහිපයකින් හදවතට දැනෙන අන්තර්ගතය', literal: 'මිනිත්තු කිහිපයකින් විශිෂ්ට අන්තර්ගතය සාදන්න' },
      { code: 'ta-LK', name: 'Tamil (Sri Lanka)', nativeName: 'தமிழ்', flag: '🇱🇰' },
      { code: 'dz-BT', name: 'Dzongkha', nativeName: 'རྫོང་ཁ', flag: '🇧🇹' },
    ],
    demoPhrase: 'Your language was never small — the world just wasn\'t listening',
    demoTranslations: { 'ne-NP': 'तपाईंको भाषा कहिल्यै सानो थिएन — संसारले सुनिरहेको थिएन' },
  },
  seo: {
    title: 'Genie Suite - AI Content Production | South Asia',
    description: 'AI content for Nepal, Sri Lanka, Bhutan & Maldives. Nepali, Sinhala, Dzongkha, Dhivehi — transcreated with cultural soul.',
    keywords: ['South Asia AI', 'Nepali content', 'Sinhala AI', 'Dzongkha', 'Maldives AI', 'South Asian transcreation'],
    hreflang: 'en',
    ogLocale: 'en_US',
  },
  welcomeScript: 'नमस्ते! आयुबोवන්! Genie Suite मा स्वागत छ। तपाईंको भाषा — तपाईंको कथा — संसारसँग साझा गर्नुहोस्।',
  showcaseExamples: [
    { title: 'Nepal Trekking Campaign', input: 'Tourism brief + cultural calendar', pipeline: 'Transcreate → Voice → Video', output: 'Trekking content in Nepali that sells the experience, not just the mountain', industry: 'Tourism' },
    { title: 'Sri Lanka Heritage Content', input: 'Heritage site brief', pipeline: 'Script → Voice → Animate', output: 'Dual Sinhala-Tamil content that unites — culturally resonant for both communities', industry: 'Tourism' },
  ],
};
...
const oceaniaConfig: RegionalConfig = {
  hero: {
    ...
    englishHeadline: 'No Worries — Your Content\'s Sorted.',
    englishSubheadline: 'Aussie English, Kiwi accent, Te Reo Māori, Pacific languages — content that sounds like home, not Hollywood.',
    nativeHeadline: 'Content That\'s Fair Dinkum — Not AI Slop',
    nativeSubheadline: 'From Sydney to Auckland, Fiji to Samoa — content that gets the Pacific',
  },
  ...
  differentiators: {
    heroBadge: 'The Pacific\'s Own Content Engine',
    firstToMarket: ['Australian English ≠ American English — and we know it', 'Te Reo Māori language support — honouring Aotearoa', 'Pacific Island languages — Samoan, Tongan, Fijian recognition'],
    capabilityDepth: ['Aussie slang-aware without being cringe — we know the line', 'Aboriginal & Torres Strait Islander cultural sensitivity', 'APRA/AMCOS compliant music and audio content'],
    onlyHere: ['True ANZ transcreation — content that sounds like your mate, not a chatbot', 'Sustainability and First Nations respect built into content guidelines'],
  },
  languageShowcase: {
    languages: [
      { code: 'en-AU', name: 'English (AU)', nativeName: 'Australian English', flag: '🇦🇺', transcreation: 'Create content that\'s proper good — in minutes', literal: 'Create stunning content in minutes' },
      { code: 'en-NZ', name: 'English (NZ)', nativeName: 'New Zealand English', flag: '🇳🇿', transcreation: 'Sweet as — content sorted in minutes', literal: 'Create stunning content in minutes' },
      { code: 'mi-NZ', name: 'Māori', nativeName: 'Te Reo Māori', flag: '🇳🇿', transcreation: 'He ihirangi e tū ana — i roto i ngā meneti' },
    ],
    demoPhrase: 'Content that sounds like home — wherever home is in the Pacific',
    demoTranslations: { 'mi-NZ': 'He ihirangi e ōrite ana ki te kāinga' },
  },
  seo: {
    title: 'Genie Suite - AI Content Production | Oceania',
    description: 'AI content for Australia, New Zealand & Pacific Islands. Aussie English, Kiwi accent, Te Reo Māori — authentic Pacific content.',
    keywords: ['Oceania AI', 'Australian content', 'ANZ production', 'Māori AI', 'Pacific content', 'New Zealand AI'],
    hreflang: 'en-AU',
    ogLocale: 'en_AU',
  },
  ...
  showcaseExamples: [
    { title: 'Outback Tourism Campaign', input: 'Tourism brief + cultural sensitivity guide', pipeline: 'Transcreate → Voice → Video', output: 'Tourism content that respects Country and sells the experience — in Aussie English and Te Reo', industry: 'Tourism' },
    { title: 'AgriTech Product Launch', input: 'Product specs + farmer audience', pipeline: 'Script → Voice → Video → Social', output: 'Content that speaks to farmers — not at them. No jargon, just value.', industry: 'Agriculture' },
  ],
};
...
const turkeyConfig: RegionalConfig = {
  hero: {
    ...
    regionName: 'Türkiye',
    theme: 'Türkiye AI',
    englishHeadline: 'Where East Meets West — Your Content Speaks Both.',
    englishSubheadline: '85 million people at the crossroads of civilizations. Türkçe that\'s Istanbul-sharp and Anatolia-warm.',
    nativeHeadline: 'İçerik üretiminde devrim — Türkçe\'nin gücüyle',
  ...
  differentiators: {
    heroBadge: 'Türkiye\'nin Kendi Yapay Zekâ İçerik Motoru',
    firstToMarket: ['Agglutinative Turkish mastery — suffixes that actually make sense', 'İstanbul cosmopolitan vs Anatolian heartland tone switching', 'Kurdish language support — Kurmancî and Zazakî'],
    capabilityDepth: ['Turkish vowel harmony in AI-generated text — not broken grammar', 'E-commerce content for Trendyol, Hepsiburada — local marketplace DNA', 'Ottoman calligraphy meets modern design — AI that respects heritage'],
    onlyHere: ['True Turkish transcreation — Google Translate\'in yapmaya cesaret edemeyeceği', 'Content that understands çay culture, hospitality, and memleket pride'],
  },
  languageShowcase: {
    languages: [
      { code: 'tr-TR', name: 'Turkish', nativeName: 'Türkçe', flag: '🇹🇷', transcreation: 'Dakikalar içinde kalbe dokunan içerik', literal: 'Dakikalar içinde etkileyici içerik oluşturun' },
      { code: 'ku-TR', name: 'Kurdish (Kurmancî)', nativeName: 'Kurdî', flag: '🇹🇷', transcreation: 'Di hûrdeman de naverok ku dilê we bi xwe dike' },
    ],
    demoPhrase: 'Content that bridges continents — just like Türkiye',
    demoTranslations: { 'tr-TR': 'Tıpkı Türkiye gibi kıtaları birleştiren içerik' },
  },
  seo: {
    title: 'Genie Suite - AI İçerik Üretimi | Türkiye',
    description: 'Türkiye için yapay zekâ içerik üretimi. Türkçe-doğal, kültürel olarak özgün, İstanbul enerjisi.',
    keywords: ['Türkiye AI', 'Türkçe içerik', 'yapay zekâ içerik', 'İstanbul AI', 'Turkish transcreation'],
    hreflang: 'tr',
    ogLocale: 'tr_TR',
  },
  ...
  showcaseExamples: [
    { title: 'E-Ticaret Kampanyası', input: 'Ürün kataloğu + trend analizi', pipeline: 'Transkreasyon → Seslendirme → Video', output: 'Trendyol & Hepsiburada\'da satış yapan içerik — Türkçe\'nin doğallığıyla', industry: 'E-Commerce' },
    { title: 'Turizm Tanıtımı', input: 'Destinasyon brief + kültürel rehber', pipeline: 'Script → Voice → 4K Video', output: 'Kapadokya\'dan Bodrum\'a — turizm içeriği that sells the dream', industry: 'Tourism' },
  ],
};
...
const easternEuropeConfig: RegionalConfig = {
  hero: {
    ...
    englishHeadline: 'Resilient Voices. Ancient Scripts. Modern Content.',
    englishSubheadline: 'Ukrainian, Georgian, Serbian, Armenian — languages with thousand-year alphabets deserve AI that respects them.',
    nativeHeadline: 'Створюйте контент, який звучить по-справжньому',
    nativeSubheadline: 'Від Києва до Тбілісі — кожна мова, кожна душа',
  },
  ...
  differentiators: {
    heroBadge: 'Eastern Europe\'s Own AI Content Engine',
    firstToMarket: ['Ukrainian AI that writes Ukrainian — not "Russian with different letters"', 'Georgian script (მხედრული) rendered with reverence — one of 14 unique alphabets in the world', 'Armenian script (Հայերեն) — 1,600 years old, now AI-powered'],
    capabilityDepth: ['Cyrillic + Latin dual-script for Serbian/Bosnian — automatic', 'Ukrainian cultural calendar — Vyshyvanka Day, Independence Day, Maidan spirit', 'Georgian polyphonic tradition awareness — content with კახური soul'],
    onlyHere: ['True Slavic & Caucasus transcreation — not Western templates with Cyrillic fonts', 'Content that understands supra, borsch, and the difference between Kyiv and Moscow'],
  },
  languageShowcase: {
    languages: [
      { code: 'uk-UA', name: 'Ukrainian', nativeName: 'Українська', flag: '🇺🇦', transcreation: 'Контент, що торкається серця — за хвилини', literal: 'Створюйте вражаючий контент за хвилини' },
      { code: 'ka-GE', name: 'Georgian', nativeName: 'ქართული', flag: '🇬🇪', transcreation: 'წუთებში შექმენით კონტენტი, რომელიც გულს ეხება' },
      { code: 'sr-RS', name: 'Serbian', nativeName: 'Српски', flag: '🇷🇸', transcreation: 'Садржај који додирује срце — за минуте' },
      { code: 'hy-AM', name: 'Armenian', nativeName: 'Հայերեն', flag: '🇦🇲', transcreation: 'Րոպdelays մdelays բовdays — սdays ևdays' },
    ],
    demoPhrase: 'Your alphabet is ancient. Your content should be cutting-edge.',
    demoTranslations: { 'uk-UA': 'Ваша абетка — давня. Ваш контент — має бути на вістрі.' },
  },
  seo: {
    title: 'Genie Suite - AI Content Production | Eastern Europe & Caucasus',
    description: 'AI content for Eastern Europe & Caucasus. Ukrainian, Georgian, Armenian, Serbian — transcreated with cultural depth.',
    keywords: ['Eastern Europe AI', 'Ukrainian content', 'Georgian AI', 'Armenian content', 'Balkan AI', 'Caucasus production'],
    hreflang: 'en',
    ogLocale: 'en_US',
  },
  ...
  showcaseExamples: [
    { title: 'Ukrainian Tech Campaign', input: 'Product brief + resilience narrative', pipeline: 'Transcreate → Voice → Video', output: 'Tech content in Ukrainian that resonates with national pride and innovation spirit', industry: 'Technology' },
    { title: 'Georgian Wine Marketing', input: 'Winery brief + 8,000-year tradition', pipeline: 'Script → Voice → 4K Video', output: 'Wine content in ქართული that honours the cradle of wine — not just another vineyard ad', industry: 'Agriculture' },
  ],
};
...
const centralAsiaConfig: RegionalConfig = {
  hero: {
    ...
    englishHeadline: 'The Silk Road Is Digital Now — And It Speaks Your Language.',
    englishSubheadline: 'Kazakh, Uzbek, Azerbaijani — Turkic languages with ancient roots and modern ambition. Finally, AI that keeps up.',
    nativeHeadline: 'Сіздің тіліңіз — сіздің күшіңіз',
    nativeSubheadline: 'Қазақша, ўзбекча, Azərbaycanca — AI контент платформасы',
  },
  ...
  differentiators: {
    heroBadge: 'Орталық Азияның AI Контент Қозғалтқышы',
    firstToMarket: ['Kazakh Latin script transition support — Cyrillic AND Latin, seamlessly', 'Uzbek content that knows Tashkent style vs Samarkand heritage', 'Azerbaijani — the bridge between Turkic and Caucasus worlds'],
    capabilityDepth: ['Triple-script mastery — Arabic, Cyrillic, Latin for the same Turkic family', 'Nowruz, Nauryz festival-aware content calendar', 'Energy sector content for Kazakhstan — oil & gas terminology in Kazakh'],
    onlyHere: ['True Central Asian transcreation — not Russian content with local words swapped', 'Silk Road heritage meets digital ambition — content worthy of Samarkand and Astana'],
  },
  languageShowcase: {
    languages: [
      { code: 'kk-KZ', name: 'Kazakh', nativeName: 'Қазақша', flag: '🇰🇿', transcreation: 'Жүрегіңізге жететін мазмұн — бірнеше минутта', literal: 'Бірнеше минутта тамаша мазмұн жасаңыз' },
      { code: 'uz-UZ', name: 'Uzbek', nativeName: 'Oʻzbekcha', flag: '🇺🇿', transcreation: 'Yurakka yetadigan kontent — bir necha daqiqada', literal: 'Bir necha daqiqada ajoyib kontent yarating' },
      { code: 'az-AZ', name: 'Azerbaijani', nativeName: 'Azərbaycanca', flag: '🇦🇿', transcreation: 'Ürəyə toxunan məzmun — bir neçə dəqiqədə', literal: 'Bir neçə dəqiqədə heyrətamiz məzmun yaradın' },
    ],
    demoPhrase: 'From Astana to Baku — content that honours your Turkic roots',
    demoTranslations: { 'kk-KZ': 'Астанадан Бакуге дейін — түркі тамырларыңызды құрметтейтін мазмұн' },
  },
  seo: {
    title: 'Genie Suite - AI Content Production | Central Asia',
    description: 'AI content for Central Asia. Kazakh, Uzbek, Azerbaijani — Turkic transcreation with Silk Road soul.',
    keywords: ['Central Asia AI', 'Kazakh content', 'Uzbek AI', 'Azerbaijani content', 'Turkic AI', 'Silk Road digital'],
    hreflang: 'en',
    ogLocale: 'en_US',
  },
  ...
  showcaseExamples: [
    { title: 'Energy Sector Campaign', input: 'Oil & gas brief + Kazakh terminology', pipeline: 'Transcreate → Voice → Video', output: 'Energy content in Kazakh that speaks to the industry — not Google Translated jargon', industry: 'Energy' },
    { title: 'Silk Road Tourism', input: 'Heritage tourism brief + Samarkand narrative', pipeline: 'Script → Voice → 4K Video', output: 'Tourism content in Uzbek that sells the heritage — Registan, Bibi-Khanym, and the spirit of the Silk Road', industry: 'Tourism' },
  ],
};
