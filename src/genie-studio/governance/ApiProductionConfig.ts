...
export const API_CONFIGURATIONS: ApiConfig[] = [
  ...
  },
  {
    ...
    endpoints: {
      development: 'managed-by-connector',
      production: 'managed-by-connector',
    },
    currentEnvironment: 'production',
    status: 'configured',
    costModel: 'usage-based',
    currentTier: 'managed',
    availableTiers: [
      { name: 'managed', monthlyLimit: 'unlimited', monthlyCost: 0, rateLimit: { requests: 1000, window: 'minute' }, recommended: true },
    ],
    ...
    lastUpdated: '2026-01-16',
    usedBy: ['ask-genie', 'ai-universal-processor'],
  },
