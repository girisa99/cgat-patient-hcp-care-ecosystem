-- Insert sample manufacturers with valid manufacturer types
...
INSERT INTO public.manufacturers (name, manufacturer_type, headquarters_location, manufacturing_capabilities, quality_certifications, contact_info, is_active) 
SELECT 'RadioPharma Inc.', 'pharma', 'Princeton, NJ, USA', ARRAY['radiopharmaceuticals', 'isotope_production', 'nuclear_medicine'], ARRAY['FDA', 'NRC', 'EMA'], '{"website": "www.radiopharma.com", "email": "info@radiopharma.com"}', true
...
SET manufacturer_id = (
  ...
  WHERE manufacturers.manufacturer_type IN ('biotech', 'pharma')
  LIMIT 1
)
