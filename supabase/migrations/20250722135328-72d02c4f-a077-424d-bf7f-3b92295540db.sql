...
-- Insert default conversation engines
INSERT INTO public.conversation_engines (name, engine_type, provider, model_identifier, configuration, capabilities, performance_profile, created_by) VALUES
('OpenAI GPT-4o', 'llm', 'openai', 'gpt-4o', 
 '{"temperature": 0.7, "max_tokens": 4096, "top_p": 1.0}',
 '{"intent_understanding": true, "entity_extraction": true, "context_management": true, "function_calling": true}',
 '{"avg_response_time_ms": 2000, "accuracy_score": 0.95, "cost_per_token": 0.00003}',
 '00000000-0000-0000-0000-000000000000'),
('Claude Sonnet', 'llm', 'anthropic', 'claude-3-sonnet-20240229', 
 '{"temperature": 0.7, "max_tokens": 4096}',
 '{"intent_understanding": true, "entity_extraction": true, "context_management": true, "reasoning": true}',
 '{"avg_response_time_ms": 1800, "accuracy_score": 0.96, "cost_per_token": 0.00003}',
 '00000000-0000-0000-0000-000000000000'),
('Local SML Intent Classifier', 'sml', 'local', 'distilbert-base-uncased-intent', 
 '{"confidence_threshold": 0.8, "max_sequence_length": 512}',
 '{"intent_understanding": true, "entity_extraction": false, "fast_inference": true}',
 '{"avg_response_time_ms": 100, "accuracy_score": 0.89, "cost_per_token": 0}',
 '00000000-0000-0000-0000-000000000000');

-- Insert default voice providers
INSERT INTO public.voice_providers (name, provider_type, configuration, capabilities, created_by) VALUES
('Twilio Voice', 'twilio', 
 '{"base_url": "https://api.twilio.com/2010-04-01", "version": "2010-04-01"}',
 '{"languages": ["en-US", "es-ES", "fr-FR"], "voice_quality": "HD", "recording": true, "transcription": true}',
 '00000000-0000-0000-0000-000000000000'),
('Five9 Platform', 'five9', 
 '{"base_url": "https://api.five9.com", "version": "v3"}',
 '{"languages": ["en-US"], "voice_quality": "HD", "call_routing": true, "analytics": true}',
 '00000000-0000-0000-0000-000000000000'),
('Genesys Cloud', 'genesys', 
 '{"base_url": "https://api.mypurecloud.com", "version": "v2"}',
 '{"languages": ["en-US", "es-ES"], "voice_quality": "HD", "omnichannel": true, "ai_insights": true}',
 '00000000-0000-0000-0000-000000000000');