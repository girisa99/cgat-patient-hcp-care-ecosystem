...
BEGIN
  ...
  INSERT INTO workflow_node_types (
    ...
    '["npi_validation", "provider_lookup", "taxonomy_codes", "nppes_integration"]'::jsonb,
  ...
  INSERT INTO workflow_node_types (
    ...
    '["cms_api", "medicare_data", "medicaid_data", "quality_measures", "provider_data"]'::jsonb,
  ...
  INSERT INTO workflow_node_types (
    ...
    '["drug_database", "device_clearance", "adverse_events", "safety_communications", "orange_book"]'::jsonb,
  ...
  INSERT INTO workflow_node_types (
    ...
    '["icd10_lookup", "icd11_support", "code_validation", "clinical_coding", "billing_codes"]'::jsonb,
  ...
  INSERT INTO workflow_node_types (
    ...
    '["hipaa_validation", "phi_protection", "access_control", "encryption_check", "audit_trail"]'::jsonb,
  ...
  INSERT INTO workflow_node_types (
    ...
    '["clinical_guidelines", "drug_interactions", "diagnostic_support", "evidence_based", "medical_knowledge"]'::jsonb,
