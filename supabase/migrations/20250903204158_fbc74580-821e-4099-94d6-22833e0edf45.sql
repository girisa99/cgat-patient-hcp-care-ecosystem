...
-- Insert consolidated 12 categories (including display_name)
...
-- 24 MCP Protocol nodes (comprehensive coverage)
...
-- Add remaining consolidated nodes for Tools & Utilities (8), Code & Deployment (6), Voice Configuration (5), Channel Deployment (6), Agent Flows (5), Human Loop (4), Cache & Memory (5)
