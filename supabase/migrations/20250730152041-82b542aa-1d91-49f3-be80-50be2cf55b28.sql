...
INSERT INTO public.manufacturers (name, manufacturer_type, headquarters_location, manufacturing_capabilities, quality_certifications, contact_info, is_active) VALUES
('BioCell Therapeutics Inc.', 'biotech', 'Boston, MA, USA', ARRAY['cell_processing', 'gmp_manufacturing', 'cold_chain'], ARRAY['FDA', 'EMA', 'PMDA'], '{"website": "www.biocell.com", "email": "contact@biocell.com"}', true),
('GeneTech Solutions', 'gene_therapy', 'South San Francisco, CA, USA', ARRAY['viral_vectors', 'gene_editing', 'analytical_testing'], ARRAY['FDA', 'EMA'], '{"website": "www.genetech.com", "email": "info@genetech.com"}', true),
('Precision Medicine Corp', 'biotech', 'Cambridge, MA, USA', ARRAY['companion_diagnostics', 'biomarker_analysis', 'sequencing'], ARRAY['FDA', 'CAP', 'CLIA'], '{"website": "www.precisionmed.com", "email": "contact@precisionmed.com"}', true),
('RadioPharma Inc.', 'pharmaceutical', 'Princeton, NJ, USA', ARRAY['radiopharmaceuticals', 'isotope_production', 'nuclear_medicine'], ARRAY['FDA', 'NRC', 'EMA'], '{"website": "www.radiopharma.com", "email": "info@radiopharma.com"}', true)
