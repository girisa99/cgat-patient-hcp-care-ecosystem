...
BEGIN
    ...
    -- Assign all demo modules to demo role
    INSERT INTO public.role_module_assignments (role_id, module_id, is_active, assigned_at)
    VALUES 
        (demo_role_id, dashboard_module_id, true, now()),
        (demo_role_id, agents_module_id, true, now()),
        (demo_role_id, patients_module_id, true, now()),
        (demo_role_id, management_module_id, true, now()),
        (demo_role_id, technical_module_id, true, now())
