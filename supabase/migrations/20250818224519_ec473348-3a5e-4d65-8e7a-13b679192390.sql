-- PHASE 1: Critical Security Fixes - Preserve All Existing Functionality (CORRECTED)
...
CREATE POLICY "Users can manage their own onboarding data secure" ON public.treatment_center_onboarding
  FOR ALL USING (
    auth.uid() IS NOT NULL AND (
