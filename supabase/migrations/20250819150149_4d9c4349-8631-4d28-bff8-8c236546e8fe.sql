-- FINAL Security Fix Phase 4 - Lock down remaining publicly accessible tables

-- ============================================================================
-- CRITICAL: Fix all remaining publicly accessible healthcare/business tables
-- ============================================================================

-- Drop any existing overly permissive policies on remaining tables
...
-- Any policies with qual:true or similar unrestricted access
...
CREATE POLICY "Healthcare professionals can view clinical trials" 
...
CREATE POLICY "Business users can view commercial products" 
...
CREATE POLICY "Business users can view manufacturers" 
...
CREATE POLICY "Business users can view service providers" 
...
CREATE POLICY "Business users can view services secure" 
ON public.services 
FOR SELECT 
TO authenticated
USING (
...
-- FINAL Phase 4 complete - All publicly accessible healthcare/business data secured