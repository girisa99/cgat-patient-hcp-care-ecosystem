-- Add missing core modules to demoUser role (fixed version)
DO $$
DECLARE
    demo_role_id uuid;
    ...
    treatment_centers_module_id uuid;
BEGIN
    -- Get role ID
    ...
    SELECT id INTO treatment_centers_module_id FROM public.modules WHERE name = 'treatment_centers';
    ...
    VALUES 
        ...
        (demo_role_id, treatment_centers_module_id, true, now())
