...
INSERT INTO public.voice_providers (name, provider_type, configuration, capabilities, is_active, health_status)
VALUES 
  ('Twilio Voice', 'voice_call', '{"api_version": "v1", "region": "us1"}', '["voice", "sms", "video", "real-time", "PSTN", "SIP"]', true, 'healthy'),
  ('Deepgram STT', 'stt', '{"model": "nova-2", "language": "en-US"}', '["STT", "real-time", "streaming", "multiple_languages"]', true, 'healthy'),
  ('ElevenLabs TTS', 'tts', '{"voice_id": "default", "model": "eleven_multilingual_v2"}', '["TTS", "natural_voice", "voice_cloning", "multilingual"]', true, 'healthy'),
  ('Azure Speech', 'speech', '{"region": "eastus", "endpoint": "https://eastus.api.cognitive.microsoft.com/"}', '["STT", "TTS", "translation"]', false, 'inactive'),
  ('OpenAI Whisper', 'stt', '{"model": "whisper-1", "language": "en"}', '["STT", "transcription", "multiple_languages"]', false, 'inactive'),
  ('Google Cloud Speech', 'speech', '{"region": "us-central1"}', '["STT", "TTS", "real-time"]', false, 'inactive')
