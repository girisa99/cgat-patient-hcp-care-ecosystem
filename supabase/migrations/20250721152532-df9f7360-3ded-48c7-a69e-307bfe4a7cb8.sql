...
UPDATE agent_sessions SET 
  current_step = 'basic_info' WHERE current_step IS NULL,
  template_type = 'custom' WHERE template_type IS NULL,
...
CREATE TRIGGER update_agent_api_assignments_updated_at
  BEFORE UPDATE ON agent_api_assignments
  FOR EACH ROW
  EXECUTE FUNCTION update_agent_sessions_updated_at();